...
import ProductsCategoryComponent from "../components/productCategory";
...
function composer(props, onData) {
  ...
  let searchParam = localStorage.getItem("category")
...
registerComponent("ProductCategory", ProductsCategoryComponent, [
