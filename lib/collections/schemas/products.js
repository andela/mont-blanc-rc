 ...
 * @property {Number} index optional, Variant position
 * number in list. Keep array index for moving variants in a list.
 ...
 * @property {Boolean} isLowQuantity optional, true when at least 1 variant is below
 ...
 * @property {Boolean} isSoldOut denormalized, Indicates when all variants `inventoryQuantity`
 *  is zero
 * @property {Boolean} isBackorder denormalized, `true` if product not in stock, but customers
